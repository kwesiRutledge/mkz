 classdef lk_pcis_controller4 < matlab.System & ...
  ...
  methods(Access = protected)
    function setupImpl(obj)
      ...
      % %Load the Map (x,y) positions of markers in MCity
      % obj.map = load('../mcity/highway.ascii');
    ...
    % update
    function updateImpl(obj, lk_acc_state, curr_pos , global_phi )
      ...
      [G,H,C_big,x0_mat] = get_mpc_matrices(sys0,obj.t_horizon);
